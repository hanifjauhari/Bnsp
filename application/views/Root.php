...
<body>
    <div class="row container-fluid" style="height:100vh;">
        <div class="col-md-3 p-3 container-fluid bg-dark" style="height:100%">
            <center>
                <h3 style="color:white">Arsip</h3>
            </center>
            <hr>
            <div class="list-group">
                <a style="color:black" href="<?= base_url('/') ?>" class="list-group-item list-group-item-action <?= $this->uri->segment(1) != 'profil' ? 'active' : 'no' ?>" aria-current="true">
                    Arsip
                </a>
                <a style="color:black" href="<?= base_url('profil') ?>" class="list-group-item list-group-item-action  <?= $this->uri->segment(1) == 'profil' ? 'active' : 'no' ?>">About</a>
            </div>
        </div>
